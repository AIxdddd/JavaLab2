...
public class IntegralUI extends javax.swing.JFrame {
    ...
    private void add_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_jButtonActionPerformed
        ...
        if (min_value >= max_value) {
            JOptionPane.showMessageDialog(IntegralUI.this, "Нижняя граница должна быть меньше верхней.");
            return;
        }
        if (step <= 0) {
            JOptionPane.showMessageDialog(IntegralUI.this, "Шаг должен быть положительным.");
            return;
        }
